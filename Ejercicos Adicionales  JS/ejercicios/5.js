...
const number = parseInt(prompt('Ingrese el D.N.I : '));
let letras = ['T','R','W','A','G','M','Y','F','P','D','X','B','N','J','Z','S','Q','V','H','L','C','K','E'];


if (isNaN(number) || number < 0 || number > 99999999) {
    alert('El número de D.N.I es inválido');
} else {
    const resultado = number % 23;
    const letraDNI = letras[resultado];
    document.write("La letra del D.N.I " + number + " es: " + letraDNI);
}
